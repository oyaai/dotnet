<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="KTMS27.aspx.vb" Inherits="Master_KTMS27" %>
...
//		});
    ...
    <div class="text_center">
        ...
        <br /><div class="font_header">SEARCH STAFF</div> 
        <br />
        <table class="table_field">
            <tr>
                <td class="table_field_td tb_Fix120">First Name</td>
                <td class="table_field_td tb_Fix600">
                    <asp:TextBox ID="txtFirstName" runat="server" MaxLength="50" CssClass="text_field"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="table_field_td tb_Fix120">Last Name</td>
                <td class="table_field_td tb_Fix600">
                    <asp:TextBox ID="txtLastName" runat="server" MaxLength="50" CssClass="text_field"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="table_field_td tb_Fix120">Section</td>
                <td class="table_field_td tb_Fix600">
                    <asp:DropDownList ID="ddlSection" runat="server" MaxLength="100" CssClass="dropdown_field"></asp:DropDownList>
        ...
        <table class="table_inquiry" width="800">
            <tr class="table_head">
                ...
                <td class="tb_Fix200">First Name</td>
                <td class="tb_Fix200">Last Name</td>
                <td class="tb_Fix250">Section</td>
            </tr>
            ...
            <asp:Repeater ID="rptInquery" runat="server">
                <itemtemplate>
                        <tr class='<%# IIf(Container.ItemIndex Mod 2 = 0, "table_item", "table_alter") %>'>
                            ...
                            <td class="tb_Fix200"><div class="ctb_Fix200 text_left"><%#DataBinder.Eval(Container.DataItem, "first_name")%></div></td>
                            <td class="tb_Fix200"><div class="ctb_Fix200 text_left"><%#DataBinder.Eval(Container.DataItem, "last_name")%></div></td>
                            <td class="tb_Fix250"><div class="ctb_Fix250 text_left"><%#DataBinder.Eval(Container.DataItem, "section")%></td>
                        </tr>
                </itemtemplate>
            </asp:Repeater>       
            <tr class="table_head">
