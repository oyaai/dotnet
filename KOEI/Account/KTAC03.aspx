<%@ Page Title="KOEI TOOL Management System" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="KTAC03.aspx.vb" Inherits="Account.KTAC03" %>
...
<script language="javascript"  type="text/javascript" >
    ...
    function IsValidDate_ClientValidate(sender, args) {
        ...
        $.ajax({
            type: "POST",
            url: "./KTAC03.aspx/IsValidDate", // <-- Page Method
    ...
    function IsExistJobOrder(sender, args) {
        ...
        $.ajax({
            type: "POST",
            url: "./KTAC03.aspx/IsExistJobOrder", // <-- Page Method
    ...
    function CheckSameVendor(sender, args) {
        ...
        $.ajax({
            type: "POST",
            url: "./KTAC03.aspx/CheckSameVendor", // <-- Page Method
    ...
    <div class="text_center">
        <br /><div class="font_size_12 text_left"><a class="fix_link" href="KTAC03.aspx?NEW=True">Accounting</a> &gt; 
            Payment
        </div>
        <br />
        ...
        <table class="table_field" style="width:1000px;">
            ...
            <tr>
                <td colspan="4" class="text_right">
                    <asp:Button ID="btnSearch" runat="server" Text="Search Payment" Width="120px" 
