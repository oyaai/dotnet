...
'	Class Name		    : KTAC02
'	Class Discription	: Webpage for input income
...
#Region "Event"
        ...
        Protected Sub Page_Init( _
            ...
            Try
                ' write start log
                objLog.StartLog("KTAC02 : Accounting Income")
            ...
            Try
                ...
                Select Case e.CommandName
                    Case "Delete"
                        ...
                        objMessage.ConfirmMessage("KTAC02", strDelResult, objMessage.GetXMLMessage("KTAC_02_001"))
                    Case "Edit"
           ...
           ByVal e As System.EventArgs _
            ...
            Try
                ...
                If Session("Action") = Action.Update Then
                    ...
                    objMessage.ConfirmMessage("KTAC02", strUpdResult, objMessage.GetXMLMessage("KTAC_02_010"))
                Else
                    If hideAccountingID.Value <> Nothing Or hideAccountingID.Value <> String.Empty Then
                        ' confirm insert message
                        objMessage.ConfirmMessage("KTAC02", strInsResult, objMessage.GetXMLMessage("KTAC_02_019"))
                    Else
                        ' confirm insert message
                        objMessage.ConfirmMessage("KTAC02", strInsResult, objMessage.GetXMLMessage("KTAC_02_002"))
                    End If
                End If
            Catch ex As Exception
                ' write error log
        ...
        Protected Sub btnApply_Click( _
            ...
            Try
                ...
                objMessage.ConfirmMessage("KTAC02", strAppResult, objMessage.GetXMLMessage("KTAC_02_015"))
            Catch ex As Exception
                ' write error log
        ...
        Protected Sub btnSearch_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSearch.Click
            ...
            sb.Append("KTAC02_Search.aspx?New=True&Type2=Income")
            sb.Append("','")
...
#Region "Function"
        ...
        '	Discription	    : Check add income duplicate function
        ...
        Private Function IsDuplication(ByVal strMode As String) As Boolean
            ...
            Try
                ...
                Dim objIncomeDto As New Dto.IncomeDto
                Dim strQueryDatatable As New StringBuilder

                objIncomeDto = Session("objIncomeDto")
                ...
                If Not IsNothing(dtTemp) Then
                    With strQueryDatatable
                        ...
                        Else
                            .Append(" AccountType = '" & objIncomeDto.AccountType & "' AND ")
                            .Append(" JobOrder = '" & objIncomeDto.JobOrder & "' AND ")
                            .Append(" VendorID = '" & objIncomeDto.VendorID & "' AND ")
                            .Append(" IEID = '" & objIncomeDto.ItemExpense & "' AND ")
                            .Append(" VatID = '" & objIncomeDto.Vat & "' AND ")
                            .Append(" WTID = '" & objIncomeDto.WT & "' AND ")
                            .Append(" SubTotal = '" & CDec(objIncomeDto.Total).ToString & "' AND ")
                            .Append(" ReceiptDate = '" & objIncomeDto.ReceiptDate & "' ")
                    ...
                    If dtTemp.Select(strQueryDatatable.ToString).Count() > 0 Then
                        objMessage.AlertMessage(objMessage.GetXMLMessage(IIf(strMode = "Search", "KTAC_02_020", "KTAC_02_016")))
                        Return True
                    End If
                End If
                IsDuplication = False
            ...
            Try
                ...
                If objUtility.GetQueryString("New") = "True" Then
                    ...
                    With sb
                        ...
                        .AppendLine("   popupSearch = window.open('','winPopSearch','width=20,height=15,toolbar=no,location=no, directories=no,status=no,menubar=no,scrollbars=no,resizable=no');")
                ...
                CheckQueryString()
                lblSumSubTotal.Text = CDec(CType(Session("dtInquiry"), DataTable).Compute("Sum(SubTotal)", "")).ToString("#,##0.00")
            Catch ex As Exception
                ' write error log
        ...
        Private Sub LoadListAccountTitle()
            Try
                ...
                ' call function GetVendorForList from service
                listAccTitleDto = objAccTitleSer.GetListAccountTitleToDDL(Enums.AccountRecordTypes.Income)
        ...
        Private Sub CheckPermission()
            Try
                ...
                objAction = objPermission.CheckPermission(Enums.MenuId.Income_KTAC)
        ...
        Private Sub SetDataToDto()
            Try
                ...
                Session("objIncomeDto") = objIncomeDto
            Catch ex As Exception
                ' write error log
        ...
        Private Sub SetDataToControl(ByVal dtAccounting As DataTable)
            Try
                ...
                With dtAccounting.Rows(0)
                    ...
                    hideStatusID.Value = Enums.RecordStatus.Waiting
                End With
        ...
        Private Function CheckInput() As Boolean
            ...
            Try
                ...
                If Not (objValidate.IsDate(txtReceiptDate.Text.Trim)) Then
                    objMessage.AlertMessage(String.Empty, "KTAC_02_021")
        ...
        Private Sub AddDataToTable()
            Try
                ...
                If Not IsNothing(dt) AndAlso dt.Rows.Count > 0 Then
                    ...
                    row("Type") = Convert.ToInt32(Enums.AccountRecordTypes.Income)
        ...
        '	Update Date	    :
        '*************************************************************/
        Private Sub ViewDetails(ByVal intIndex As Integer)
            Try
                ' variable table object
                Dim dt As DataTable = Session("dtInquiry")
                ' variable row object
                Dim rows() As DataRow = dt.Select(" Index = '" & intIndex & "'")
                ' get data to row
                ...
                objMessage.ShowPagePopup("KTAC02_Detail.aspx?Type=Income", 500, 500)
            Catch ex As Exception
                ' write error log
                objLog.ErrorLog("DeleteRow", ex.Message.ToString, Session("UserName"))
            End Try
        ...
        Private Sub PrepareRptVoucher()
            Try
                ...
                Session("dtWTRpV2t") = objVoucher.GetDataForWTReportV2(Session("voucherList"))
            Catch ex As Exception
                ' Write error log 
        ...
        Private Sub ShowReport(ByVal strPath() As String, ByVal urlOldPage As String)
            Try
                ...
                sb.Append("<script type = 'text/javascript'>")
                sb.Append("window.onload = function OpenPopup() {")
                sb.Append("alert('" & objMessage.GetXMLMessage("KTAC_02_011") & "');")
        ...
        Private Sub InsertIncome()
            Try
                ...
                Dim strPathArray(1) As String
                ' Call function InsertIncome
                If objAccountSer.InsertIncome(Session("dtInquiry")) Then
                    ' case success alert msg KTAC_03_011 and refresh new page
                    PrepareRptVoucher()
                    strPathArray(0) = "../Report/ReportViewer.aspx?ReportName=KTAC&Page=KTAC02"
                    strPathArray(1) = objAccPaymentSer.ExcelPaymentWTReport(Session("dtWTRpt"), "Income")
                    'strPathArray(2) = objAccPaymentSer.ExcelPaymentWTReportV2(Session("dtWTRpV2t"), "Income")
                    ShowReport(strPathArray, "KTAC02.aspx?New=True")
                    objValidate.DeleteReportFile()
                Else
                    ' case failure alert msg KTAC_02_013
                    objMessage.AlertMessage("", "KTAC_02_013")
                End If
            Catch ex As Exception
                ' write error log
                objLog.ErrorLog("InsertIncome", ex.Message.ToString, Session("UserName"))
            End Try
        End Sub
        ...
        Private Sub SetValidateErrorMessage()
            Try
                reqInputVat.ErrorMessage = objMessage.GetXMLMessage("KTAC_02_004")
                reqInputWT.ErrorMessage = objMessage.GetXMLMessage("KTAC_02_005")
                reqReceiptDate.ErrorMessage = objMessage.GetXMLMessage("KTAC_02_008")
                reqDateInvalid.ErrorMessage = objMessage.GetXMLMessage("KTAC_02_021")
                reqSubTotal.ErrorMessage = objMessage.GetXMLMessage("KTAC_02_006")
                reqSameVendor.ErrorMessage = objMessage.GetXMLMessage("KTAC_02_017")
