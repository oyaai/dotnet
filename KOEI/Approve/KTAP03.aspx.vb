...
'
' INITIAL INFOMATION
'	Package Name	    : Cheque Approve
'	Class Name		    : Approve_KTAP03
'	Class Discription	: Webpage for Cheque Approve
...
#Region "Event"
    ...
    Protected Sub Page_Init( _
        ...
        Try
            ' write start log
            objLog.StartLog("KTAP03 : Cheque Approve")
    ...
    Protected Sub btnApprove_Click( _
        ...
        Try
            ...
            objMessage.ConfirmMessage("KTAP03", constApprove, objMessage.GetXMLMessage("KTAP_02_003"))
    ...
    Protected Sub btnDecline_Click( _
        ...
        Try
            ...
            GetAccountID() 'Keep Id
            ' case not used then confirm message to delete
            objMessage.ConfirmMessage("KTAP03", constDecline, objMessage.GetXMLMessage("KTAP_02_004"))
            'Set enable/disable to button
            SetButton()
    ...
    Protected Sub btnDelete_Click( _
        ...
        Try
            ...
            ' case not used then confirm message to delete
            objMessage.ConfirmMessage("KTAP03", constDelete, objMessage.GetXMLMessage("KTAP_02_005"))
            'Set enable/disable to button
            SetButton()
    ...
    Protected Sub rptApprove_ItemCommand( _
        ...
        Try
            ...
            ' set ID to session
            Session("intID") = strID
            'strChequeDate = ChangeFormatDate(strChequeDate).ToString("dd/MMM/yyyy")
            Select Case e.CommandName
                Case "Detail"
                    'redirect to KTAC07_Detail
                    Dim strPath As String = "../Purchase/KTPU07_Detail.aspx?strId=" & strID
                    'strPath = "javascript:showpopup('" & strPath & "','_blank');"
                    'ScriptManager.RegisterClientScriptBlock(Page, Page.GetType(), "ShowDetail", strPath, True)
                    'Page.ClientScript.RegisterClientScriptBlock(Page.GetType(), "ShowDetail", strPath)
                    Dim sb As New System.Text.StringBuilder()
                    sb.Append("var w = parseInt(screen.availWidth * 0.71);")
    ...
    '/**************************************************************
    '	Function name	: ChangeFormatDate
    '	Discription	    : Change date(yyyymmdd)
    '	Return Value	: Date
    '	Create User	    : Boonyarit
    '	Create Date	    : 08-08-2013
    '	Update User	    :
    '	Update Date	    :
    '*************************************************************/
    Private Function ChangeFormatDate(ByVal strDate As String) As Date
        Dim newDate As Date
    ...
    Protected Sub rptApprove_ItemDataBound( _
       ...
       ByVal e As System.Web.UI.WebControls.RepeaterItemEventArgs _
        ...
        Try
            ...
            hashID.Add(e.Item.ItemIndex, DataBinder.Eval(e.Item.DataItem, "newid"))
...
#Region "Function"
    ...
    Private Sub SearchData()
        Try
            ...
            ' call function GetChequeApproveList from AcountService
            dtAccountApprove = objAccountingSer.GetChequeApproveList(Session("objAccountApproveDto"))
    ...
    Private Sub CheckPermission()
        Try
            ...
            objAction = objPermission.CheckPermission(Enums.MenuId.ChequeApprove)
    ...
    Private Sub GetAccountID()
        Try
            ...
            For Each item As RepeaterItem In rptApprove.Items
                Dim intID As String = hashID(i).ToString
    ...
    Private Sub UpdateAccount(ByVal intStatus As Integer)
        Try
            ...
            If objAccountingSer.UpdateChequeApprove(Session("itemConfirm"), "3", intStatus) Then
