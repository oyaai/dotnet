<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="KTAD01.aspx.vb" Inherits="Admin_KTAD01" %>
...
<asp:ToolkitScriptManager ID="ToolkitScriptManager1" EnablePageMethods="True" runat="server" />
    ...
    <div class="text_center">
        ...
        <br />
        <div class="font_header">SEARCH USER LOGIN</div> 
        <br />
        <table class="table_field">
            <tr>
                <td class="table_field_td tb_Fix120"> User Name</td>
                ...
                <td class="table_field_td tb_Fix120">Department</td>
                <td class="table_field_td tb_Fix300">
            ...
            <tr>
                <td class="table_field_td tb_Fix120">First Name</td>
                <td class="table_field_td tb_Fix300">
                    <asp:TextBox ID="txtFirstName" runat="server" MaxLength="50"></asp:TextBox>
                </td>
                <td class="table_field_td tb_Fix120">Last Name</td>
                <td class="table_field_td tb_Fix300">
        ...
        <table class="table_inquiry" width="800">
            <tr class="table_head">
                ...
                <td class="tb_Fix100">User Name</td>
                <td class="tb_Fix100">Password</td>
                <td class="tb_Fix100">First Name</td>
                <td class="tb_Fix110">Last Name</td>
                <td class="tb_Fix110">Department</td>
                <td class="tb_Fix130">Last Login</td>
            ...
            <asp:Repeater ID="rptInquery" runat="server">
                <itemtemplate>
                    <tr class='<%# IIf(Container.ItemIndex Mod 2 = 0, "table_item", "table_alter") %>'>
                        <td class="tb_Fix50"><div class="ctb_Fix50"><asp:LinkButton ID="btnEdit" CausesValidation="false" CommandName="Edit" CssClass="icon_edit1 icon_center15" runat="server"></asp:LinkButton></td>
                        <td class="tb_Fix50"><div class="ctb_Fix50"><asp:LinkButton ID="btnDel" CausesValidation="false" CommandName="Del" CssClass="icon_del1 icon_center15" runat="server"></asp:LinkButton></td>
                        <td class="text_left tb_Fix100"><div class="ctb_Fix100"><%#DataBinder.Eval(Container.DataItem, "user_name")%></div></td>
                        <td class="text_left tb_Fix100"><div class="ctb_Fix100"><%#DataBinder.Eval(Container.DataItem, "password")%></div></td>
                        <td class="text_left tb_Fix100"><div class="ctb_Fix100"><%#DataBinder.Eval(Container.DataItem, "first_name")%></div></td>
                        <td class="text_left tb_Fix110"><div class="ctb_Fix110"><%#DataBinder.Eval(Container.DataItem, "last_name")%></div></td>
                        <td class="text_left tb_Fix110"><div class="ctb_Fix110"><%#DataBinder.Eval(Container.DataItem, "department")%></div></td>
                        <td class="text_left tb_Fix130"><div class="ctb_Fix130"><%#DataBinder.Eval(Container.DataItem, "last_login")%></div></td>
                        <td class="tb_Fix50"><div class="ctb_Fix50"><asp:LinkButton ID="btnDetails" CausesValidation="false" CommandName="View" CssClass="icon_detail1 icon_center15" runat="server"></asp:LinkButton></td>
                    </tr> 
                </itemtemplate>
            </asp:Repeater>            
              <tr class="table_head">
