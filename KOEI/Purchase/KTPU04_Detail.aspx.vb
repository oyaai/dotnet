...
#Region "Event"
    ...
    Protected Sub Page_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
        Try
            objLog.StartLog("KTPU04_Detail", Session("UserName"))
...
#Region "Function"
    ...
    Private Sub DisplayHead()
        Try
            ...
            If Not IsNothing(dtGetInvoice_Header) AndAlso dtGetInvoice_Header.Rows.Count > 0 Then
                ...
                lblType_Of_Purchase.Text = dtGetInvoice_Header.Rows(0)("po_type_name").ToString()
                lblPO_No.Text = dtGetInvoice_Header.Rows(0)("po_no").ToString()
                lblDevery_Plan.Text = dtGetInvoice_Header.Rows(0)("delivery_date").ToString()
                lblQuotation_No.Text = dtGetInvoice_Header.Rows(0)("quotation_no").ToString()
                lblVendor_Name.Text = dtGetInvoice_Header.Rows(0)("vendor_name").ToString()
                lblPayment_Term.Text = dtGetInvoice_Header.Rows(0)("payment_term").ToString()
                lblVAT.Text = dtGetInvoice_Header.Rows(0)("VAT").ToString()
                lblWT.Text = dtGetInvoice_Header.Rows(0)("WT").ToString()
                lblCurrency.Text = dtGetInvoice_Header.Rows(0)("currency_Name").ToString()
                lblRemarks.Text = dtGetInvoice_Header.Rows(0)("remark").ToString()
                lblATTN.Text = dtGetInvoice_Header.Rows(0)("attn").ToString()
                lblDevery_To.Text = dtGetInvoice_Header.Rows(0)("deliver_to").ToString()
                lblContact.Text = dtGetInvoice_Header.Rows(0)("contact").ToString()
                lblSub_Total.Text = dtGetInvoice_Header.Rows(0)("sub_total").ToString()
                lblDiscount_Total.Text = dtGetInvoice_Header.Rows(0)("discount_total").ToString()
                lblVat_Total.Text = dtGetInvoice_Header.Rows(0)("vat_amount").ToString()
                lblWT_Total.Text = dtGetInvoice_Header.Rows(0)("wt_amount").ToString()
                lblTotal_Amount.Text = dtGetInvoice_Header.Rows(0)("total_amount").ToString()
            Else
    ...
    Private Sub SearchHeadData()
        Try
            ...
            dtGetInvoice_Header = objInv_PurchaseService.GetPO_Header(Session("objInv_PurchaseDetailDto"))
    ...
    Private Sub SearchDetailData()
        Try
            ...
            'call function GetItemList from ItemService
            dtGetInvoice_Detail = objInv_PurchaseService.GetPO_Detail(Session("objInv_PurchaseDetailDto"))
